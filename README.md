# Service-Provider-Finder-React-Native-app
...
## ✔️This app is built with React Native 0.70.5, Firebae Authentication, and Firebase Realtime Database
<br>
...
- #### `utils/http.js ` - holds firebase database link
